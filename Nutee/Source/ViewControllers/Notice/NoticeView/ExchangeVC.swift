...
class ExchangeVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.exchangeTV.register(UITableViewCell.self, forCellReuseIdentifier: "NoticeTVC")
                
        exchangeTV.register(UINib(nibName: "NoticeTVC", bundle: nil), forCellReuseIdentifier: "NoticeTVC")
...
extension ExchangeVC {
    func setNotice(){
        NoticeService.shared.getExchangeNotice(){
            [weak self]
            data in
